...
// Wed Jun 26 12:49:41 2019 by ROOT version 6.14/06
// from TTree Delphes/Analysis tree
// found on file: run01_Higgs0or1Jet_PtGen_0_inf_forPtReco_0_80_120GeV.root
//////////////////////////////////////////////////////////

#ifndef Run01Signal_h
#define Run01Signal_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3715;
   static constexpr Int_t kMaxTrack = 159;
   static constexpr Int_t kMaxTower = 284;
   static constexpr Int_t kMaxEFlowTrack = 159;
   static constexpr Int_t kMaxEFlowPhoton = 98;
...
#ifdef Run01Signal_cxx
Run01Signal::Run01Signal(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run01_Higgs0or1Jet_PtGen_0_inf_forPtReco_0_80_120GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("run01_Higgs0or1Jet_PtGen_0_inf_forPtReco_0_80_120GeV.root");
      }
...
Run01Signal::~Run01Signal()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Run01Signal::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Run01Signal::LoadTree(Long64_t entry)
{
...
void Run01Signal::Init(TTree *tree)
{
...
void Run01Signal::Show(Long64_t entry)
{
...
Int_t Run01Signal::Cut(Long64_t entry)
{
