...
// Mon Jul  1 03:35:53 2019 by ROOT version 6.14/06
// from TTree Delphes/Analysis tree
// found on file: run06_pp2aa_01j_PtGen_370_620_forPtReco450_550GeV.root
//////////////////////////////////////////////////////////

#ifndef Run06Background_h
#define Run06Background_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3791;
   static constexpr Int_t kMaxTrack = 181;
   static constexpr Int_t kMaxTower = 298;
   static constexpr Int_t kMaxEFlowTrack = 181;
   static constexpr Int_t kMaxEFlowPhoton = 111;
   static constexpr Int_t kMaxEFlowNeutralHadron = 157;
   ...
   Run06Background(TTree *tree=0);
   virtual ~Run06Background();
...
#ifdef Run06Background_cxx
Run06Background::Run06Background(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run06_pp2aa_01j_PtGen_370_620_forPtReco450_550GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("run06_pp2aa_01j_PtGen_370_620_forPtReco450_550GeV.root");
      }
...
Run06Background::~Run06Background()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Run06Background::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Run06Background::LoadTree(Long64_t entry)
{
...
void Run06Background::Init(TTree *tree)
{
...
void Run06Background::Show(Long64_t entry)
{
...
Int_t Run06Background::Cut(Long64_t entry)
{
...
#endif // #ifdef Run06Background_cxx
