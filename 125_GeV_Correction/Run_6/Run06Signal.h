...
// Mon Jul  1 03:35:10 2019 by ROOT version 6.14/06
// from TTree Delphes/Analysis tree
// found on file: run06_Higgs0or1Jet_PtGen_370_620_forPtReco450_550GeV.root
//////////////////////////////////////////////////////////

#ifndef Run06Signal_h
#define Run06Signal_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 4085;
   static constexpr Int_t kMaxTrack = 214;
   static constexpr Int_t kMaxTower = 349;
   static constexpr Int_t kMaxEFlowTrack = 214;
   static constexpr Int_t kMaxEFlowPhoton = 131;
...
#ifdef Run06Signal_cxx
Run06Signal::Run06Signal(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run06_Higgs0or1Jet_PtGen_370_620_forPtReco450_550GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("run06_Higgs0or1Jet_PtGen_370_620_forPtReco450_550GeV.root");
      }
...
Run06Signal::~Run06Signal()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Run06Signal::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Run06Signal::LoadTree(Long64_t entry)
{
...
void Run06Signal::Init(TTree *tree)
{
...
void Run06Signal::Show(Long64_t entry)
{
...
Int_t Run06Signal::Cut(Long64_t entry)
{
