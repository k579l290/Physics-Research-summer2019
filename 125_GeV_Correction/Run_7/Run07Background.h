...
// Mon Jul  1 06:33:30 2019 by ROOT version 6.14/06
// from TTree Delphes/Analysis tree
// found on file: run07_pp2aa_01j_PtGen_450_820_forPtReco550_750GeV.root
//////////////////////////////////////////////////////////

#ifndef Run07Background_h
#define Run07Background_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 4244;
   static constexpr Int_t kMaxTrack = 200;
   static constexpr Int_t kMaxTower = 313;
   static constexpr Int_t kMaxEFlowTrack = 200;
   static constexpr Int_t kMaxEFlowPhoton = 125;
   static constexpr Int_t kMaxEFlowNeutralHadron = 171;
   ...
   Run07Background(TTree *tree=0);
   virtual ~Run07Background();
...
#ifdef Run07Background_cxx
Run07Background::Run07Background(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run07_pp2aa_01j_PtGen_450_820_forPtReco550_750GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("run07_pp2aa_01j_PtGen_450_820_forPtReco550_750GeV.root");
      }
...
Run07Background::~Run07Background()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Run07Background::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Run07Background::LoadTree(Long64_t entry)
{
...
void Run07Background::Init(TTree *tree)
{
...
void Run07Background::Show(Long64_t entry)
{
...
Int_t Run07Background::Cut(Long64_t entry)
{
...
#endif // #ifdef Run07Background_cxx
