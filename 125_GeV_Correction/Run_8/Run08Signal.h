...
// Mon Jul  1 06:34:14 2019 by ROOT version 6.14/06
// from TTree Delphes/Analysis tree
// found on file: run08_Higgs0or1Jet_PtGen_650_inf_forPtReco750_infGeV.root
//////////////////////////////////////////////////////////

#ifndef Run08Signal_h
#define Run08Signal_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 4014;
...
#ifdef Run08Signal_cxx
Run08Signal::Run08Signal(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run08_Higgs0or1Jet_PtGen_650_inf_forPtReco750_infGeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("run08_Higgs0or1Jet_PtGen_650_inf_forPtReco750_infGeV.root");
      }
...
Run08Signal::~Run08Signal()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Run08Signal::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Run08Signal::LoadTree(Long64_t entry)
{
...
void Run08Signal::Init(TTree *tree)
{
...
void Run08Signal::Show(Long64_t entry)
{
...
Int_t Run08Signal::Cut(Long64_t entry)
{
