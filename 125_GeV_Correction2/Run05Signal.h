...
// Mon Jul  1 02:55:41 2019 by ROOT version 6.14/06
// from TTree Delphes/Analysis tree
// found on file: run05_Higgs0or1Jet_PtGen_270_510_forPtReco350_450GeV.root
//////////////////////////////////////////////////////////

#ifndef Run05Signal_h
#define Run05Signal_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3953;
   static constexpr Int_t kMaxTrack = 209;
   static constexpr Int_t kMaxTower = 316;
   static constexpr Int_t kMaxEFlowTrack = 209;
   static constexpr Int_t kMaxEFlowPhoton = 120;
...
#ifdef Run05Signal_cxx
Run05Signal::Run05Signal(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run05_Higgs0or1Jet_PtGen_270_510_forPtReco350_450GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("run05_Higgs0or1Jet_PtGen_270_510_forPtReco350_450GeV.root");
      }
...
Run05Signal::~Run05Signal()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Run05Signal::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Run05Signal::LoadTree(Long64_t entry)
{
...
void Run05Signal::Init(TTree *tree)
{
...
void Run05Signal::Show(Long64_t entry)
{
...
Int_t Run05Signal::Cut(Long64_t entry)
{
