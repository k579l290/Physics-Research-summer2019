...
// Thu Jun 27 11:14:51 2019 by ROOT version 6.14/06
// from TTree Delphes/Analysis tree
// found on file: run03_Higgs0or1Jet_PtGen_130_330_forPtReco200_270GeV.root
//////////////////////////////////////////////////////////

#ifndef Run03Signal_h
#define Run03Signal_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3971;
   static constexpr Int_t kMaxTrack = 182;
   static constexpr Int_t kMaxTower = 309;
   static constexpr Int_t kMaxEFlowTrack = 182;
   static constexpr Int_t kMaxEFlowPhoton = 107;
   static constexpr Int_t kMaxEFlowNeutralHadron = 160;
...
#ifdef Run03Signal_cxx
Run03Signal::Run03Signal(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run03_Higgs0or1Jet_PtGen_130_330_forPtReco200_270GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("run03_Higgs0or1Jet_PtGen_130_330_forPtReco200_270GeV.root");
      }
...
Run03Signal::~Run03Signal()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Run03Signal::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Run03Signal::LoadTree(Long64_t entry)
{
...
void Run03Signal::Init(TTree *tree)
{
...
void Run03Signal::Show(Long64_t entry)
{
...
Int_t Run03Signal::Cut(Long64_t entry)
{
