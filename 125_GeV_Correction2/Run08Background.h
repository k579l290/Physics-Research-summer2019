...
// Mon Jul  1 06:34:48 2019 by ROOT version 6.14/06
// from TTree Delphes/Analysis tree
// found on file: run08_pp2aa_01j_PtGen_650_inf_forPtReco750_infGeV.root
//////////////////////////////////////////////////////////

#ifndef Run08Background_h
#define Run08Background_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3838;
   static constexpr Int_t kMaxTrack = 215;
   static constexpr Int_t kMaxTower = 330;
   static constexpr Int_t kMaxEFlowTrack = 215;
   static constexpr Int_t kMaxEFlowPhoton = 140;
   ...
   Run08Background(TTree *tree=0);
   virtual ~Run08Background();
...
#ifdef Run08Background_cxx
Run08Background::Run08Background(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run08_pp2aa_01j_PtGen_650_inf_forPtReco750_infGeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("run08_pp2aa_01j_PtGen_650_inf_forPtReco750_infGeV.root");
      }
...
Run08Background::~Run08Background()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Run08Background::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Run08Background::LoadTree(Long64_t entry)
{
...
void Run08Background::Init(TTree *tree)
{
...
void Run08Background::Show(Long64_t entry)
{
...
Int_t Run08Background::Cut(Long64_t entry)
{
...
#endif // #ifdef Run08Background_cxx
