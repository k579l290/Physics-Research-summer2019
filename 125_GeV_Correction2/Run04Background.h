...
// Mon Jul  1 01:05:33 2019 by ROOT version 6.14/06
// from TTree Delphes/Analysis tree
// found on file: run04_pp2aa_01j_PtGen_200_410_forPtReco270_350GeV.root
//////////////////////////////////////////////////////////

#ifndef Run04Background_h
#define Run04Background_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3894;
   static constexpr Int_t kMaxTrack = 179;
   static constexpr Int_t kMaxTower = 293;
   static constexpr Int_t kMaxEFlowTrack = 179;
   static constexpr Int_t kMaxEFlowPhoton = 106;
   static constexpr Int_t kMaxEFlowNeutralHadron = 166;
   ...
   Run04Background(TTree *tree=0);
   virtual ~Run04Background();
...
#ifdef Run04Background_cxx
Run04Background::Run04Background(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run04_pp2aa_01j_PtGen_200_410_forPtReco270_350GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("run04_pp2aa_01j_PtGen_200_410_forPtReco270_350GeV.root");
      }
...
Run04Background::~Run04Background()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Run04Background::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Run04Background::LoadTree(Long64_t entry)
{
...
void Run04Background::Init(TTree *tree)
{
...
void Run04Background::Show(Long64_t entry)
{
...
Int_t Run04Background::Cut(Long64_t entry)
{
...
#endif // #ifdef Run04Background_cxx
