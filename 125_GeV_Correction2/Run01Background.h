...
// Tue Jun 25 13:14:19 2019 by ROOT version 6.14/06
// from TTree Delphes/Analysis tree
// found on file: run01_pp2aa_01j_PtGen_0_inf_forPtReco_0_80_120GeV.root
//////////////////////////////////////////////////////////

#ifndef Run01Background_h
#define Run01Background_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3906;
   static constexpr Int_t kMaxTrack = 141;
   static constexpr Int_t kMaxTower = 266;
   static constexpr Int_t kMaxEFlowTrack = 141;
   static constexpr Int_t kMaxEFlowPhoton = 90;
   static constexpr Int_t kMaxEFlowNeutralHadron = 152;
   ...
   Run01Background(TTree *tree=0);
   virtual ~Run01Background();
...
#ifdef Run01Background_cxx
Run01Background::Run01Background(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run01_pp2aa_01j_PtGen_0_inf_forPtReco_0_80_120GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("run01_pp2aa_01j_PtGen_0_inf_forPtReco_0_80_120GeV.root");
      }
...
Run01Background::~Run01Background()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Run01Background::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Run01Background::LoadTree(Long64_t entry)
{
...
void Run01Background::Init(TTree *tree)
{
...
void Run01Background::Show(Long64_t entry)
{
...
Int_t Run01Background::Cut(Long64_t entry)
{
...
#endif // #ifdef Run01Background_cxx
