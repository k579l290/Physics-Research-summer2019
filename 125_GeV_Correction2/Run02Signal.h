...
// Thu Jun 27 08:53:23 2019 by ROOT version 6.14/06
// from TTree Delphes/Analysis tree
// found on file: run02_Higgs0or1Jet_PtGen_50_250_forPtReco120_200GeV.root
//////////////////////////////////////////////////////////

#ifndef Run02Signal_h
#define Run02Signal_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3753;
   static constexpr Int_t kMaxTrack = 167;
   static constexpr Int_t kMaxTower = 298;
   static constexpr Int_t kMaxEFlowTrack = 167;
...
#ifdef Run02Signal_cxx
Run02Signal::Run02Signal(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run02_Higgs0or1Jet_PtGen_50_250_forPtReco120_200GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("run02_Higgs0or1Jet_PtGen_50_250_forPtReco120_200GeV.root");
      }
...
Run02Signal::~Run02Signal()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Run02Signal::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Run02Signal::LoadTree(Long64_t entry)
{
...
void Run02Signal::Init(TTree *tree)
{
...
void Run02Signal::Show(Long64_t entry)
{
...
Int_t Run02Signal::Cut(Long64_t entry)
{
