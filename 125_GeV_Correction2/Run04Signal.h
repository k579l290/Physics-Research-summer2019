...
// Mon Jul  1 01:06:09 2019 by ROOT version 6.14/06
// from TTree Delphes/Analysis tree
// found on file: run04_Higgs0or1Jet_PtGen_200_410_forPtReco270_350GeV.root
//////////////////////////////////////////////////////////

#ifndef Run04Signal_h
#define Run04Signal_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 4128;
   static constexpr Int_t kMaxTrack = 178;
   static constexpr Int_t kMaxTower = 308;
   static constexpr Int_t kMaxEFlowTrack = 178;
   static constexpr Int_t kMaxEFlowPhoton = 111;
   static constexpr Int_t kMaxEFlowNeutralHadron = 169;
...
#ifdef Run04Signal_cxx
Run04Signal::Run04Signal(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run04_Higgs0or1Jet_PtGen_200_410_forPtReco270_350GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("run04_Higgs0or1Jet_PtGen_200_410_forPtReco270_350GeV.root");
      }
...
Run04Signal::~Run04Signal()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Run04Signal::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Run04Signal::LoadTree(Long64_t entry)
{
...
void Run04Signal::Init(TTree *tree)
{
...
void Run04Signal::Show(Long64_t entry)
{
...
Int_t Run04Signal::Cut(Long64_t entry)
{
