...
// Thu Jun 27 11:14:10 2019 by ROOT version 6.14/06
// from TTree Delphes/Analysis tree
// found on file: run03_pp2aa_01j_PtGen_130_330_forPtReco200_270GeV.root
//////////////////////////////////////////////////////////

#ifndef Run03Background_h
#define Run03Background_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3998;
   static constexpr Int_t kMaxTrack = 164;
   static constexpr Int_t kMaxTower = 295;
   static constexpr Int_t kMaxEFlowTrack = 164;
   static constexpr Int_t kMaxEFlowPhoton = 106;
   static constexpr Int_t kMaxEFlowNeutralHadron = 151;
   static constexpr Int_t kMaxGenJet = 13;
   ...
   Run03Background(TTree *tree=0);
   virtual ~Run03Background();
...
#ifdef Run03Background_cxx
Run03Background::Run03Background(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run03_pp2aa_01j_PtGen_130_330_forPtReco200_270GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("run03_pp2aa_01j_PtGen_130_330_forPtReco200_270GeV.root");
      }
...
Run03Background::~Run03Background()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Run03Background::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Run03Background::LoadTree(Long64_t entry)
{
...
void Run03Background::Init(TTree *tree)
{
...
void Run03Background::Show(Long64_t entry)
{
...
Int_t Run03Background::Cut(Long64_t entry)
{
...
#endif // #ifdef Run03Background_cxx
