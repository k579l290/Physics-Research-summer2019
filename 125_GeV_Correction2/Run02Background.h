...
// Thu Jun 27 08:52:46 2019 by ROOT version 6.14/06
// from TTree Delphes/Analysis tree
// found on file: run02_pp2aa_01j_PtGen_50_250_forPtReco120_200GeV.root
//////////////////////////////////////////////////////////

#ifndef Run02Background_h
#define Run02Background_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 3801;
   static constexpr Int_t kMaxTrack = 155;
   static constexpr Int_t kMaxTower = 283;
   static constexpr Int_t kMaxEFlowTrack = 155;
   static constexpr Int_t kMaxEFlowPhoton = 93;
   ...
   Run02Background(TTree *tree=0);
   virtual ~Run02Background();
...
#ifdef Run02Background_cxx
Run02Background::Run02Background(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run02_pp2aa_01j_PtGen_50_250_forPtReco120_200GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("run02_pp2aa_01j_PtGen_50_250_forPtReco120_200GeV.root");
      }
...
Run02Background::~Run02Background()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Run02Background::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Run02Background::LoadTree(Long64_t entry)
{
...
void Run02Background::Init(TTree *tree)
{
...
void Run02Background::Show(Long64_t entry)
{
...
Int_t Run02Background::Cut(Long64_t entry)
{
...
#endif // #ifdef Run02Background_cxx
