...
// Mon Jul  1 02:56:47 2019 by ROOT version 6.14/06
// from TTree Delphes/Analysis tree
// found on file: run05_pp2aa_01j_PtGen_270_510_forPtReco350_450GeV.root
//////////////////////////////////////////////////////////

#ifndef Run05Background_h
#define Run05Background_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static constexpr Int_t kMaxParticle = 4346;
   static constexpr Int_t kMaxTrack = 188;
   static constexpr Int_t kMaxTower = 344;
   static constexpr Int_t kMaxEFlowTrack = 188;
   static constexpr Int_t kMaxEFlowPhoton = 117;
   static constexpr Int_t kMaxEFlowNeutralHadron = 182;
   ...
   Run05Background(TTree *tree=0);
   virtual ~Run05Background();
...
#ifdef Run05Background_cxx
Run05Background::Run05Background(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("run05_pp2aa_01j_PtGen_270_510_forPtReco350_450GeV.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("run05_pp2aa_01j_PtGen_270_510_forPtReco350_450GeV.root");
      }
...
Run05Background::~Run05Background()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Run05Background::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Run05Background::LoadTree(Long64_t entry)
{
...
void Run05Background::Init(TTree *tree)
{
...
void Run05Background::Show(Long64_t entry)
{
...
Int_t Run05Background::Cut(Long64_t entry)
{
...
#endif // #ifdef Run05Background_cxx
